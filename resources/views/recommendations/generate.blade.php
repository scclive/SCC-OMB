...
@section('content')
    ...
    <br>
    <br>
    <button class="btn btn-info" id="downloadPDF">Download PDF <sup>Beta</sup></button>
    <!-- <center><img style="margin-top:200px; width:80px;" src="../img/recommend.png"/></center> -->
    ...
    <!-- <div class="row header">
        <div class="col-sm-1"></div>
            <div class="col-sm-11 align-self-center pagination-centered text-center btn btn-primary center-block" style="border: 6px solid orange; height:220px;">

                

                <div class="col-sm-2 text-center" style="height:150px;">
                    <img style="width:100px; padding-top:20px;" src="{{  URL::to ('/img/notebook.png')}}"/>
                </div>

                <div class="col-sm-8 text-center align-items-center" style="height:150px; vertical-align: middle;">
    ...
    <!-- <div class="row">
        <div class="col-sm-12">
            <div class="panel-body">
                ...
                <div class="row" style="padding-left:50px; height:200px;">
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-sm-12 text-center" style="color: #000;">
                            <h3>Student Career Consultant <b style="color: #ff5e13;"> SCC</b></h3>
                        </div>
                    </div>
                </div>
    ...
    <div id="content2">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="panel-body">
                    ...
                    <div class="row" style="padding-left:50px; border: 6px solid orange; height:300px; 
        ...
        <div class="row">
            <div class="col-sm-12" style="padding-left: 50px; padding-right:50px;">
                <div class="panel-body">
                    ...
                    <div class="row" style="border: 6px solid white; height:300px;">
                        <div class="row">
                            <div class="col-sm-3"></div>
                            <div class="col-sm-3 text-center align-items-center" style="color: #000; height:150px; vertical-align: middle;">
                                <center><h3><b style="color: #ff5e13;"> SCC</b><br><b>Assessment <br>Report</b></h3></center>
                            </div>

                            <div class="col-sm-1" style="border-left: 2px solid black; height: 90px; left: 50%; position:absolute;"></div>

                            <div class="col-sm-2 text-center" style="height:150px; vertical-align: middle;">
        ...
        <div class="row">
            <div class="col-sm-12" style="padding-left: 50px; padding-right:50px;">
                <div class="panel-body">
                    ...
                    <div class="row" style="border: 6px solid white; border-top-color: #f7d881; height:300px;">
                        <div class="row">
        ...
        <div style="display:block;">
            <div class="row">
                <div class="col-sm-12" style="padding-left: 50px; padding-right:50px;">
                    <div class="panel-body">
                        ...
                        <div class="row headerpersonality" style="padding-left:50px; border: 6px solid orange; height:300px;">
            ...
            <div class="row">
                <div class="col-sm-12" style="padding-left: 170px; padding-right:170px;">
                    <div class="panel-body">
            ...
            <div class="row">
                <div class="col-sm-12 text-center" id="container5" style="height: 400px; padding-left: 170px; padding-right:170px;">
                ...
                @if($key == 'realistic')
                    ...
                    <div class="row">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="row" style="border: 6px solid white; border-top-color: #f7d881; height:300px;">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-11  align-items-center" style="border: 6px solid black; border-left-color: white;" >
                        ...
                        @if(!empty($dbrealistic))
                            ...
                            <div class="table-responsive"  style="padding-left: 170px; padding-right:170px;">
                                <table class="sortable table table-striped table-bordered">
                                    <thead>
                                        <tr>
                                            <th>Institute</th>
            ...
            <div class="row">
                <div class="col-sm-12" style="padding-left: 50px; padding-right:50px;">
                    <div class="panel-body">
                        ...
                        <div class="row headerpastrecord" style="padding-left:50px; border: 6px solid orange; height:300px;">
                ...
                <div class="row">
                    <div class="col-sm-12 text-center" id="container1" style="height: 400px; padding-left: 170px; padding-right:170px;">
                ...
                <div class="row">
                    <div class="col-sm-12" style="padding-left: 170px; padding-right:170px;">
                        <div class="panel-body">
                            ...
                            <div class="row" style="border: 6px solid white; border-top-color: #f7d881; height:200px;">
                                <div class="row">
                                    <div class="col-sm-4"></div>
                                    <div class="col-sm-4 text-center align-items-center">
                ...
                <br>
                <div class="row">
                    <div class="col-sm-12 text-center" id="container2" style="height: 400px; padding-left: 170px; padding-right:170px;">
            ...
            <div class="row">
                <div class="col-sm-12" style="padding-left: 50px; padding-right:50px;">
                    <div class="panel-body">
                        ...
                        <div class="row headerentrytest" style="padding-left:50px; border: 6px solid orange; height:300px;">
                ...
                <div class="row text-center" style="padding-left: 200px; padding-right:200px;">
                    <div class="col-sm-12">
                        <h2>
                ...
                <div class="row">
                    <div class="col-sm-12 text-center" id="container3" style="height: 400px; padding-left: 170px; padding-right:170px;">
            ...
            <div class="row">
                <div class="col-sm-12" style="padding-left: 50px; padding-right:50px;">
                    <div class="panel-body">
                        ...
                        <div class="row headerstrongsubjects" style="padding-left:50px; border: 6px solid orange; height:300px;">
                ...
                <div class="row">
                    <div class="col-sm-12 text-center" id="container4" style="height: 400px; padding-left: 100px; padding-right:100px;">
                            ...
                            <div class="row" style="border: 6px solid white; border-top-color: #f7d881; height:300px;">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8 text-center">
                                        <h2> Your Score </h2>
                                        <div class="row">
                                            <div class="col-sm-12 text-center" id="container6" style="height: 400px; padding-left: 100px; padding-right:100px;">
                            ...
                            <div class="row" style="border: 6px solid white; border-top-color: #f7d881; height:300px;">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8 text-center">
                                        <h2> Your Score </h2>
                                        <div class="row">
                                            <div class="col-sm-12 text-center" id="container7" style="height: 400px; padding-left: 100px; padding-right:100px;">
                            ...
                            <div class="row" style="border: 6px solid white; border-top-color: #f7d881; height:300px;">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8 text-center">
                                        <h2> Your Score </h2>
                                        <div class="row">
                                            <div class="col-sm-12 text-center" id="container8" style="height: 400px; padding-left: 100px; padding-right:100px;">
        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="panel-body">
                    ...
                    <div class="row footer" style="padding-left:50px; border: 6px solid orange; height:200px;">
                        <div class="row">
                            <div class="col-sm-9 text-center"></div>
                            <div class="col-sm-1 text-center">
                                <img style="width:75px; padding-top:45px;" src="{{  URL::to ('/img/recommend.png')}}"/> 
                            </div>
                            <div class="col-sm-1 text-center">
                                <img style="width:75px; padding-top:40px;" src="{{  URL::to ('/img/notebook.png')}}"/> 
                            </div>
                        </div>
                        <div class="row">
